...
import { BrandContextSettings } from '@gitroom/frontend/components/brand-context/brand-context-settings';
export const SettingsPopup: FC<{
  ...
  const list = useMemo(() => {
    ...
    arr.push({ tab: 'brand_context', label: t('brand_context', 'Brand Context') });
